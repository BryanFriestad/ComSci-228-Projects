...
public class Explore {
    ...
    public void run(NoiseFilterReader rdr ) throws ParseErrorException {
        ...
        BareG g = tGraph;
        Coordinate startCoord = tGraph.getStart();
        Coordinate endCoord = tGraph.getGoal();
        if(startCoord != null && endCoord != null){
        	BareV start = g.getVertex(startCoord.getLinear());
            BareV goal  = g.getVertex(endCoord.getLinear());
