...
public class ImageCache {
    ...
    static FileAssn[] bgAssn = {
            ...
            new FileAssn("bg_desert.png", TerrainType.kDesert),
            new FileAssn("bg_alpine.png", TerrainType.kAlpine),
            new FileAssn("bg_swamp.png", TerrainType.kSwamp)
    };
    
    static FileAssn[] txpAssn = {
            // using weight for transport cost
            new FileAssn("wall.png", ConnType.wall),
            new FileAssn("fence.png", ConnType.fence),
            new FileAssn("canyon.png", ConnType.canyon),
